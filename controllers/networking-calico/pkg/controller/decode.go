...
import (
	"github.com/gardener/gardener-extensions/controllers/networking-calico/pkg/apis/calico/install"
...
func CalicoNetworkConfigFromNetworkResource(network *extensionsv1alpha1.Network) (*calicov1aplha1.NetworkConfig, error) {
