...
func ComputeCalicoChartValues(network *extensionsv1alpha1.Network, config *calicov1alpha1.NetworkConfig) map[string]interface{} {
	return map[string]interface{}{
		"images": map[string]interface{}{
			calico.CNIImageName:             "quay.io/calico/node:v3.7.2",
			calico.TyphaImageName:           "quay.io/calico/cni:v3.7.2",
			calico.KubeControllersImageName: "quay.io/calico/typha:v3.7.2",
			calico.NodeImageName:            "quay.io/calico/kube-controllers:v3.7.2",
		},
