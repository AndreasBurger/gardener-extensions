...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkConfigStatus)(nil), (*calico.NetworkConfigStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkConfigStatus_To_calico_NetworkConfigStatus(a.(*NetworkConfigStatus), b.(*calico.NetworkConfigStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.NetworkConfigStatus)(nil), (*NetworkConfigStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_NetworkConfigStatus_To_v1alpha1_NetworkConfigStatus(a.(*calico.NetworkConfigStatus), b.(*NetworkConfigStatus), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	if err := Convert_v1alpha1_IPAM_To_calico_IPAM(&in.IPAM, &out.IPAM, s); err != nil {
		return err
	}
...
func autoConvert_calico_NetworkConfig_To_v1alpha1_NetworkConfig(in *calico.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	if err := Convert_calico_IPAM_To_v1alpha1_IPAM(&in.IPAM, &out.IPAM, s); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NetworkConfigStatus_To_calico_NetworkConfigStatus(in *NetworkConfigStatus, out *calico.NetworkConfigStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_NetworkConfigStatus_To_calico_NetworkConfigStatus is an autogenerated conversion function.
func Convert_v1alpha1_NetworkConfigStatus_To_calico_NetworkConfigStatus(in *NetworkConfigStatus, out *calico.NetworkConfigStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkConfigStatus_To_calico_NetworkConfigStatus(in, out, s)
}

func autoConvert_calico_NetworkConfigStatus_To_v1alpha1_NetworkConfigStatus(in *calico.NetworkConfigStatus, out *NetworkConfigStatus, s conversion.Scope) error {
	return nil
}

// Convert_calico_NetworkConfigStatus_To_v1alpha1_NetworkConfigStatus is an autogenerated conversion function.
func Convert_calico_NetworkConfigStatus_To_v1alpha1_NetworkConfigStatus(in *calico.NetworkConfigStatus, out *NetworkConfigStatus, s conversion.Scope) error {
	return autoConvert_calico_NetworkConfigStatus_To_v1alpha1_NetworkConfigStatus(in, out, s)
}
